        ...
        return (
            <Row className="justify-content-center no-gutters">
                ...
                <Col className="pt-2 app-content-main">
                    <Switch>
                        <PrivateRouteAdminAndSuperUser path="/dashboard/NewMovie" component={NewMovie} />
                        <Route path="/dashboard/AllMovies" component={ShowAllMovies} />
                        <Route path="/dashboard/TopTenMovies" component={TopTenMovies} />
                        <PrivateRouteAdminAndSuperUser path="/dashboard/EditMovie/:id" component={EditMovie} />
                        ...
                        <Route path="/dashboard/ProjectionDetails" component={ProjectionDetails} />
                        <PrivateRouteAdminAndSuperUser path="/dashboard/EditProjection" component={EditProjection} />
                        <PrivateRouteAdminSuperUserAndUser path="/dashboard/UserProfile" component={UserProfile} />
