...
class NewAuditorium extends React.Component {
    ...
    validate(id, value) {
        if (id === 'auditName') {
            ...
            if (!value) {
                this.setState({cinemaIdError: 'Please chose cinema from dropdown list.',
                                canSubmit: false})
            } else {
                ...
                <Row>
                    <Col>
                        ...
                        <FormGroup>
                            ...
                            <Button type="submit" className="btn-add-new" disabled={submitted || !canSubmit} block>Add</Button>
                        </form>
                    </Col>
                </Row>
                <Row className="mt-2">
